JSONeditor={
    ...
    setJsonMessage: function(message) {
        var messageDiv = document.getElementById('jformMessage');
    ...
    formatJSON: function() {
        var form = document.forms.jsoninput;
        var jsonValue = form.jvalue.value;

        try {
            var jsonObject = JSON.parse(jsonValue);
            var formattedJSON = JSON.stringify(jsonObject, null, 4); // 4 spaces for indentation
            form.jvalue.value = formattedJSON;
            this.setJsonMessage('JSON formatted successfully!');
        } catch (e) {
	...
	formHTML: `<form name="jsoninput" onsubmit="return treeBuilder.jsonChange(this)">
    <div id="jExamples">Load an example:&nbsp;<select name="jloadExamples" onchange="JSONeditor.loadExample(this.value)">
    ...
    Label:<br><input name="jlabel" type="text" value="" size="60" style="width:100%"><br><br>
    Value: <br><textarea name="jvalue" rows="10" cols="50" style="width:100%;max-width:100%;"></textarea><br><br>
    ...
    <input name="orgjlabel" type="hidden" value="" size="50" style="width:100%">
    <input onfocus="this.blur()" type="submit" value="Save">&nbsp;
    <br><br>
    <div class="button-grid">
        <input name="jAddChild" onfocus="this.blur()" type="button" onclick="treeBuilder.jsonAddChild(this.parentNode.parentNode)" value="Add child">
        <input name="jAddSibling" onfocus="this.blur()" type="button" onclick="treeBuilder.jsonAddSibling(this.parentNode.parentNode)" value="Add sibling">
        <input name="jRemove" onfocus="this.blur()" type="button" onclick="treeBuilder.jsonRemove(this.parentNode.parentNode)" value="Delete">
        <input name="jRename" onfocus="this.blur()" type="button" onclick="treeBuilder.jsonRename(this.parentNode.parentNode)" value="Rename">
        <input name="jCut" onfocus="this.blur()" type="button" onclick="treeBuilder.jsonCut(this.parentNode.parentNode)" value="Cut">
        <input name="jCopy" onfocus="this.blur()" type="button" onclick="treeBuilder.jsonCopy(this.parentNode.parentNode)" value="Copy">
